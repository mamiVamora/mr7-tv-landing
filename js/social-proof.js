...
function initRecentSubscriptions() {
    // قائمة بأسماء ومدن وهمية وواقعية
    const names = ['محمد', 'أحمد', 'عبدالله', 'خالد', 'فهد', 'عمر', 'سلطان', 'علي', 'يوسف', 'إبراهيم'];
    const cities = ['الرياض', 'جدة', 'دبي', 'الكويت', 'الدوحة', 'القاهرة', 'عمان', 'المنامة', 'بغداد', 'مسقط'];
